...
// <summary>This is the bridge wetween the file browser and the UI.</summary>
...
public class UI_FileBrowser : MonoBehaviour
{
	...
	public string originCustomImagePath;
	public string destCustomImagePath;
    ...
    void Awake()
    {
		...
		CustomImageController = GameObject.Find ("CustomImageController").GetComponent<CustomImageManager> ();
		...
		*/
		...
		_FB.SetFilters(new string[] { ".jpg", ".jpeg", ".png" });

		destCustomImagePath = Application.persistentDataPath + "/Custom Image";
    }
	...
	*/
	...
	#region Import Image
	public void ImportCustomImage(string originPath, string destPath, string destImageName)
	{
		if (!Directory.Exists (destPath))
			Directory.CreateDirectory (destPath);
		else
			System.IO.File.Copy (originPath, destPath + "/" + destImageName);

		CustomImageController.TravelCustomImageFolder ();

		CustomImageController.SetImageData_InCustomImageManager ();
		CustomImageController.ShowImage_InCustomImageManager ();

		CustomImageController.SetImageData_InLGLevelCreator ();
		CustomImageController.ShowImage_InLGLevelCreator ();
	}
	#endregion
}
